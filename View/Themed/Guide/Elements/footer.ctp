				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="fh5co-right"><small class="fh5co-right">Développé par <small>MrSheepSheep</small> & modifié par la Team Apotheios. Propulsé par <a href="http://mineweb.org/" target="_blank">Mineweb</a>.</small></p>
						</div>
					</div>
				</div>
			</div>
